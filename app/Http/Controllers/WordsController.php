...
class WordsController extends Controller {
	...
	public function statistics()
	{
		...
		$statistics_data['total']['total_all'] = Word::all()->count();
		$statistics_data['total']['total_nouns'] = Word::where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['total']['total_adjectives'] = Word::where('type', '>', 199)->where('type', '<', 300)->count();
		$statistics_data['total']['total_verbs'] = Word::where('type', '>', 299)->where('type', '<', 400)->count();
		$statistics_data['total']['total_other'] = Word::where('type', '>', 399)->where('type', '<', 999)->count();
		$statistics_data['total']['total_percent'] = '';

		// English
		$statistics_data['EN']['name'] = 'English';
		$statistics_data['EN']['total_all'] = Word::where('EN', '!=', '')->count();
		$statistics_data['EN']['total_nouns'] = Word::where('EN', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['EN']['total_adjectives'] = Word::where('EN', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['FR']['total_nouns'] = Word::where('FR', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['FR']['total_adjectives'] = Word::where('FR', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['DK']['total_nouns'] = Word::where('DK', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['DK']['total_adjectives'] = Word::where('DK', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['PL']['total_nouns'] = Word::where('PL', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['PL']['total_adjectives'] = Word::where('PL', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['ES']['total_nouns'] = Word::where('ES', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['ES']['total_adjectives'] = Word::where('ES', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['DK_PL']['total_nouns'] = Word::where('DK', '!=', '')->where('PL', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['DK_PL']['total_adjectives'] = Word::where('DK', '!=', '')->where('PL', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['ES_PL']['total_nouns'] = Word::where('ES', '!=', '')->where('PL', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['ES_PL']['total_adjectives'] = Word::where('ES', '!=', '')->where('PL', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
		...
		$statistics_data['DK_ES']['total_nouns'] = Word::where('DK', '!=', '')->where('ES', '!=', '')->where('type', '>', 99)->where('type', '<', 200)->count();
		$statistics_data['DK_ES']['total_adjectives'] = Word::where('DK', '!=', '')->where('ES', '!=', '')->where('type', '>', 199)->where('type', '<', 300)->count();
